      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1 md:col-span-2 flex flex-col items-start gap-4">
          ...
          <div className="mt-4 flex flex-col gap-2">
            ...
            <a href={`tel:+${SALES_PHONE_E164}`} className="text-sm font-medium text-zinc-900 dark:text-zinc-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center gap-2">
