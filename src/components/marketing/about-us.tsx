      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          <div className="flex flex-col gap-8">
            <div className="inline-flex items-center gap-2 bg-blue-50 px-3 py-1 rounded-full border border-blue-100 w-fit">
              <span className="text-xs font-medium text-blue-600 uppercase tracking-widest">
                {t("landing.about.badge")}
              </span>
            </div>

            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black leading-[1.1] max-w-xl">
            ...
            >
              {[
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-black">{t(item.labelKey)}</h3>
          ...
          <div className="relative">
            <motion.div
              className="w-full max-w-md mx-auto bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-2xl border border-neutral-200 p-8 relative overflow-hidden"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.3 }}
              variants={scaleIn}
            ...
            >
              ...
              <div className="relative z-10 flex flex-col items-center gap-5 text-center">
                <div className="w-20 h-20 rounded-2xl bg-white/80 backdrop-blur-sm border border-neutral-200 flex items-center justify-center shadow-xl">
                ...
                <div className="flex items-center justify-center gap-4 pt-4 border-t border-neutral-200 w-full">
                  <div className="flex flex-col items-center">
                    <p className="text-xl font-bold text-black">7+</p>
            ...
            <motion.div
              className="absolute -bottom-6 -left-6 w-32 h-32 bg-blue-100 rounded-full blur-3xl opacity-50"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            />
            <motion.div
              className="absolute -top-4 -right-4 w-24 h-24 bg-purple-100 rounded-full blur-3xl opacity-50"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
