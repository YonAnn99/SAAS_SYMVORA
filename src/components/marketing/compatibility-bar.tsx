...
export function CompatibilityBar() {
  ...
  return (
    <motion.section
      ...
      className="w-full py-10 sm:py-12 bg-white border-b border-neutral-100"
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {items.map(({ icon: Icon, key }) => (
            ...
            >
              <span
                className="w-9 h-9 sm:w-10 sm:h-10 bg-blue-50 text-blue-600 rounded-lg flex items-center justify-center shrink-0"
                aria-hidden="true"
              >
