...
export function Benefits() {
  ...
  return (
    <motion.section
      className="w-full bg-white py-24 border-t border-neutral-100"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
        ...
        >
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-transparent" aria-hidden="true" />
            <motion.div
            ...
            >
              <motion.div
                className="w-16 h-16 rounded-2xl bg-blue-50 flex items-center justify-center border border-blue-100"
            ...
            <motion.div
              className="absolute -bottom-4 -right-4 w-32 h-32 bg-blue-50 rounded-full blur-2xl"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
